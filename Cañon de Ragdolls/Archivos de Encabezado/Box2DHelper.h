...
//-------------------------------------------------------------
	...
	//-------------------------------------------------------------
	static b2DistanceJoint* CreateDistanceJoint(b2World* phyWorld, b2Body* first, b2Vec2 anchorFirst, b2Body* second, b2Vec2 anchorSecond, float distance, float freq, float damp) {
	...
	//-------------------------------------------------------------
	static b2MouseJoint* CreateMouseJoint(b2World* phyWorld, b2Body* second,
		float maxForce) {
